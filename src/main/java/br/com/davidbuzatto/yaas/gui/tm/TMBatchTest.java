...
/**
 * A dialog for batch testing strings against Turing Machines.
 * 
 * @author Prof. Dr. David Buzatto
 */
public class TMBatchTest extends javax.swing.JDialog {

    private TMInternalFrame tmIFrame;
    private TMAcceptanceType acceptanceType;
    
    private TM tm;
    
    /**
     * Creates new form TMBatchTest
     */
    public TMBatchTest( Frame parent, TMInternalFrame tmIFrame, TMAcceptanceType acceptanceType, boolean modal ) {
        super( parent, modal );
    ...
    private void btnTestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTestActionPerformed
        ...
        for ( String str : strings ) {
            ...
            boolean accepted = tm.accepts( str, acceptanceType );
