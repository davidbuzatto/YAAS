...
public class PDAInternalFrame extends javax.swing.JInternalFrame {
    ...
    private Deque<PDA> undoStack;
    private Deque<PDA> redoStack;
                ...
                if ( originState != null ) {
                    ...
                    if ( targetState != null ) {
                        ...
                        if ( op != null ) {
                            ...
                            pda.addTransition( t );
                            updateTransitionsCurvature( originState, targetState, pda.getTransitions(), 30, 30, 10 );
                            setCurrentFileSaved( false );
                        }
        ...
        if ( canDrag ) {
            ...
            if ( btnSelectMultipleStates.isSelected() ) {
                ...
                if ( !selectedStates.isEmpty() ) {
                    ...
                    if ( btnSnapToGrid.isSelected() && !pda.getStates().isEmpty() ) {
                        if ( moveAnchor == null ) {
                            moveAnchor = getStateClosestTo( pda.getStates(), xPressed, yPressed );
                        }
        ...
        if ( selectedState != null ) {
            for ( PDATransition t : pda.getTransitions() ) {
                if ( t.getOriginState().equals( selectedState ) ) {
                    updateTransitionsCurvature( t.getOriginState(), t.getTargetState(), pda.getTransitions(), 30, 30, 10 );
                }
            }
        }
     ...
     */
    private PDAState getStateClosestTo( List<PDAState> states, int x, int y ) {
        PDAState closest = null;
    ...
    private void updateTransitionsCurvature( 
        PDAState originState, 
        PDAState targetState, 
        List<PDATransition> transitions, 
        int distance, 
        int angleDis, 
        int labelDist ) {
        
        PDATransition t1 = null;
        PDATransition t2 = null;
