...
import br.com.davidbuzatto.yaas.gui.tm.table.TMTransitionFunctionTableCellRenderer;
...
/**
 * A dialog to show the formal definition of Turing Machines.
 * 
 * @author Prof. Dr. David Buzatto
 */
public class TMFormalDefinitionDialog extends javax.swing.JDialog {

    private TMInternalFrame tmIFrame;
    private TM tm;
    
    /**
     * Creates new form TMFormalDefinitionDialog
     */
    public TMFormalDefinitionDialog( java.awt.Frame parent, TMInternalFrame tmIFrame, TM tm, boolean modal ) {
        super( parent, modal );
    ...
    private void customInit() {
        ...
        TMTransitionFunctionTableModel m = Utils.createTMTransitionFunctionTableModel( tm );
        
        textAreaFD.setText( tm.getFormalDefinition() );
        tableDelta.getTableHeader().setFont( DrawingConstants.DEFAULT_TABLE_FONT );
        tableDelta.setDefaultRenderer( 
                String.class, new TMTransitionFunctionTableCellRenderer() );
