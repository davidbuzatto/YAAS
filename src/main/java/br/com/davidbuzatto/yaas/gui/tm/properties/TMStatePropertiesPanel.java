...
/**
 * TMState properties edit/visualization panel.
 * 
 * @author Prof. Dr. David Buzatto
 */
public class TMStatePropertiesPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form TMStatePropertiesPanel
     */
    public TMStatePropertiesPanel( TMInternalFrame tmIFrame ) {
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        if ( state != null ) {
            ...
            Utils.showErrorMessage( tmIFrame, "There's no selected state!" );
        }
    ...
    private void ccpColorMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ccpColorMouseReleased
        ...
        Color c = JColorChooser.showDialog( tmIFrame, "State Color", 
    ...
    private void utmteStateCustomLabel() {
