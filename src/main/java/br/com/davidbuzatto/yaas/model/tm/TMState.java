...
public class TMState extends AbstractGeometricForm implements Comparable<TMState>, Cloneable {
    ...
    public TMState( int number ) {
        this( number, null, false, false );
    }
    
    public TMState( int number, boolean initial, boolean _final ) {
        this( number, null, initial, _final );
    }
    
    public TMState( int number, String customLabel, boolean initial, boolean _final ) {
    ...
    public void mouseHover( int x, int y ) {
        if ( TMState.this.intersects( x, y ) ) {
            mouseHover = true;
            return;
        }
        mouseHover = false;
